...
class BiLSTM(BaseModel):
	...
	"""
	def __init__(self, n_labels, word_vocab_size, max_seq_len, char_vocab_size=None, word_embedding_dim=100,
	...
	def construct(self):
		...
		w_ids = Input(shape=(self._max_seq_len,), dtype='int32')
		...
		if self._embeddings is None:
			word_embeddings = Embedding(input_dim=self._word_vocab_size,
																	...
																	mask_zero=False,
																	input_length=self._max_seq_len)(w_ids)
